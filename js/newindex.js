...
window.addEventListener('load', DrawPlaceholder(img1,ctx1,"#308F98",'p2.jpg',345,200));
...
img3.crossOrigin="anonymous";
    ...
    window.addEventListener('load', DrawPlaceholder(img3,ctx3,"#FFFFFF",'p4.jpg',350,200));
